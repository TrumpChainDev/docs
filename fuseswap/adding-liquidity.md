---
description: We will learn on how to add liquidity to Fuseswap on ERAM/USDC pair.
---
...
* USDC and ERAM should be on Eram network. To learn how to transfer them to Eram network using Fuseswap via Bridge please go through this [**tutorial**](../the-fuse-chain/token-bridges/transfer-fuse-using-bridge-on-fuseswap.md).

**Step 1:**

Navigate to [www.eramswap.com](https://eramswap.com/) .The interface will look like as shown below

![](../.gitbook/assets/0%20%287%29.png)

Use **“Connect to a wallet”** on the right hand top corner to connect your wallet with Fuseswap. Once you connect you should be able to see your wallet address and see that you are connected to Fuseswap via Eram network.
